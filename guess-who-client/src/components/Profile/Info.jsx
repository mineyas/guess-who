...
export default function Info() {
  ...
  return (
    <section className="section h-[90vh] bg-primary-dark">
      <div className="container flex_col gap-8 h-fit w-3/5">
        ...
        >
          ...
          <div className="flex_row justify-end gap-2">
            {isEdit ? (
              <>
                <button type="submit" className="bg-green-400 hover:bg-green-100 text-white hover:text-green-400 font-semibold py-2 px-4 rounded">
                  Save
                </button>
                <button
